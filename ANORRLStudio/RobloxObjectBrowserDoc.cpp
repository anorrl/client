...
void DeclarationView::updateDeclarationView(ObjectBrowserItem* item)
{
	...
	if (const ARL::Reflection::FunctionDescriptor* fd = dynamic_cast<const ARL::Reflection::FunctionDescriptor*>(desc))
	{
		...
		bRobloxRestricted  = (fd->security == ARL::Security::RobloxPlace);
	...
	else if (const ARL::Reflection::YieldFunctionDescriptor* yfd = dynamic_cast<const ARL::Reflection::YieldFunctionDescriptor*>(desc))
	{
		...
		bRobloxRestricted  = (yfd->security == ARL::Security::RobloxPlace);
	...
	else if (const ARL::Reflection::PropertyDescriptor* pd = dynamic_cast<const ARL::Reflection::PropertyDescriptor*>(desc))
	{
		...
		bRobloxRestricted  = (pd->security == ARL::Security::RobloxPlace);
	...
	else if (const ARL::Reflection::EventDescriptor* ed = dynamic_cast<const ARL::Reflection::EventDescriptor*>(desc))
	{
		...
		bRobloxRestricted  = (ed->security == ARL::Security::RobloxPlace);
