...
IRobloxDoc::ARLCloseRequest RobloxScriptDoc::requestClose()
{
...
void RobloxScriptDoc::setScript(shared_ptr<ARL::DataModel> dm, LuaSourceBuffer script)
{
	if (m_script == script)
		return;
...
void RobloxScriptDoc::onAncestryChanged(shared_ptr<ARL::Instance> newParent)
{
	if (newParent==NULL)
	{
...
void RobloxScriptDoc::onPropertyChanged(const ARL::Reflection::PropertyDescriptor* desc)
{
