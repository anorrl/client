...
static const char qt_meta_stringdata_SplineEditorAdapter[] = {
    ...
    "onClosed()\0pd\0"
    "onPropChanged(const ARL::Reflection::PropertyDescriptor*)\0"
    ",\0"
    "onAncestryChanged(shared_ptr<ARL::Instance>,shared_ptr<ARL::Instance>)\0"
};
...
void SplineEditorAdapter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onPropChanged((*reinterpret_cast< const ARL::Reflection::PropertyDescriptor*(*)>(_a[1]))); break;
        case 3: _t->onAncestryChanged((*reinterpret_cast< shared_ptr<ARL::Instance>(*)>(_a[1])),(*reinterpret_cast< shared_ptr<ARL::Instance>(*)>(_a[2]))); break;
        default: ;
        }
    }
}
