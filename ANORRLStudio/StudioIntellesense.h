...
namespace Studio {
    ...
    private:
		...
		int repopulateUserVariables(const std::vector<ARL::ScriptAnalyzer::IntellesenseResult>& result, unsigned int row, unsigned int column);
        ...
        void populateProperty(const ARL::Reflection::PropertyDescriptor* d);
        void populateFunction(const ARL::Reflection::FunctionDescriptor* d);
        void populateYieldFunction(const ARL::Reflection::YieldFunctionDescriptor* d);
        void populateEvent(const ARL::Reflection::EventDescriptor* d);
        void populateCallBack(const ARL::Reflection::CallbackDescriptor* d);
        void populateEnumerator(const ARL::Reflection::EnumDescriptor::Item* d);

        int populateItemLists(QString text, int row, int index, bool searchDatamodel, const boost::optional<std::vector<ARL::ScriptAnalyzer::IntellesenseResult> >& result);
        bool populateItemListsFromVariant(const ARL::Reflection::Variant varValue, bool showAllChildren = false);
		...
		shared_ptr<ARL::LuaSourceContainer> getCurrentScript();
