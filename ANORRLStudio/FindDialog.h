...
private:
	...
	ANORRLFindWidget::eFindFlags getCurrentFlags();
...
public:
	...
	FindDialog* getFindDialog() { ARLASSERT(m_pFindDialog); return m_pFindDialog; }
	ReplaceDialog* getReplaceDialog() { ARLASSERT(m_pReplaceDialog); return m_pReplaceDialog; }
	FindAllDialog* getFindAllDialog() { ARLASSERT(m_pFindAllDialog); return m_pFindAllDialog; }
	GoToLineDialog* getGotoLineDialog() { ARLASSERT(m_pGotoLineDialog); return m_pGotoLineDialog; }
	EmbeddedFindReplaceWidget* getEmbeddedFindDialog() { ARLASSERT(m_pEmbeddedFindReplaceWidget); return m_pEmbeddedFindReplaceWidget; }
