...
public:
	...
	virtual bool open(ANORRLMainWindow *pMainWindow, const QString &fileName) = 0;
	virtual bool close() = 0;
	
	virtual ARLCloseRequest requestClose() = 0;

	virtual ARLDocType docType() = 0;
