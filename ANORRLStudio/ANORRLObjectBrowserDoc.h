...
class ANORRLObjectBrowserDoc: public QObject, public ANORRLBasicDoc
{
	Q_OBJECT

public:

	ANORRLObjectBrowserDoc();
	~ANORRLObjectBrowserDoc();
	...
	IANORRLDoc::ARLDocType docType() { return IANORRLDoc::OBJECTBROWSER; }
