...
static const char qt_meta_stringdata_RobloxIDEDoc[] = {
    ...
    "exportSelection(std::string,ARL::ExporterSaveType)\0"
...
void RobloxIDEDoc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->exportSelection((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< ARL::ExporterSaveType(*)>(_a[2]))); break;
