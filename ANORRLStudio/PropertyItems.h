...
typedef std::list< ARL::Instance* >                          InstanceList;
typedef std::list<const ARL::Reflection::ClassDescriptor*>   Classes;

class PropertyItem: public QTreeWidgetItem
{
public:
	PropertyItem(const ARL::Reflection::PropertyDescriptor *pPropertyDescriptor);
	PropertyItem(PropertyItem *pParentItem, const QString &name);
	virtual ~PropertyItem();

	//factory method
	static PropertyItem* createItem(const ARL::Reflection::PropertyDescriptor* pPropertyDescriptor);
	...
	virtual int compareInstanceValues(ARL::Instance *pPreviousInstance, ARL::Instance *pCurrentInstance);

	virtual void pushInstanceValue(ARL::Instance *pInstance);
	virtual void pullInstanceValue(ARL::Instance *pInstance);

	virtual void setVariantValue(const ARL::Reflection::Variant &value);
	virtual ARL::Reflection::Variant getVariantValue();	
	...
	const ARL::Reflection::PropertyDescriptor* propertyDescriptor() const { return m_pPropertyDescriptor; }

	PropertyTreeWidget* getTreeWidget();
	bool hasError() const {  return m_hasExceptionError; }

protected:
	void addClassDescriptor(const ARL::Reflection::ClassDescriptor* pClassDescriptor);
    ...
    bool handleCollisionLocally(ARL::Instance* pInstance);	

	Classes                                         m_Classes;
	const ARL::Reflection::PropertyDescriptor      *m_pPropertyDescriptor;
	PropertyItem                                   *m_pParentItem;

	ARL::Reflection::Variant                        m_variantValue;
...
public:
	...
	BrickColorPropertyItem(const ARL::Reflection::PropertyDescriptor *pPropertyDescriptor);
...
public:
	...
	ColorPropertyItem(const ARL::Reflection::PropertyDescriptor *pPropertyDescriptor);
...
public:
	...
	DoublePropertyItem(const ARL::Reflection::PropertyDescriptor *pPropertyDescriptor);
