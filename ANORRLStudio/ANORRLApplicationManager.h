...
class ANORRLApplicationManager
{
public:
...
public:
	...
	bool startChildProcess(const QString& anorrlApp, const QStringList &args, NewInstanceMode mode);
	void cleanupChildProcesses(int timeout = 3000);
	bool hasChildProcesses();
