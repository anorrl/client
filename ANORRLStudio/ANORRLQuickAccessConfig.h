...
class QuickAccessConfigDialog : public ANORRLSavingStateDialog<QDialog>
{
    Q_OBJECT
...
class ANORRLQuickAccessConfig : public QObject
{
	Q_OBJECT
public:

	static ANORRLQuickAccessConfig& singleton();
