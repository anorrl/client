...
public:
	...
	T& getViewWidget(EDebuggerViewID id) const
	{
		...
		ARLASSERT(m_ViewWidgets[id]);
		QWidget* widget = m_ViewWidgets[id];
		ARLASSERT(dynamic_cast<T*>(widget));
...
private:
	...
	void onDebuggerClientActivated(int currentBreakpoint, ARL::Scripting::ScriptDebugger::Stack currentStack);
	...
	void onBreakpointAdded(shared_ptr<ARL::Scripting::DebuggerBreakpoint> spBreakpoint);
	void onBreakpointRemoved(shared_ptr<ARL::Scripting::DebuggerBreakpoint> spBreakpoint);
	
	void onWatchAdded(shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
	void onWatchRemoved(shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
...
{
public:
	StackDetailsItem(const ARL::Scripting::ScriptDebugger::FunctionInfo& funcInfo, bool isFirstItem);
	~StackDetailsItem();
	void activate();
...
private:
	...
	boost::shared_ptr<ARL::Instance> m_spAssociatedScript;
	bool                             m_bIsFirstItem;
};
...
public:
	...
	void setCallStack(const ARL::Scripting::ScriptDebugger::Stack& stack);
...
{
public:
	BreakpointItem(boost::shared_ptr<ARL::Scripting::DebuggerBreakpoint> breakpoint);
	~BreakpointItem();

	bool hasBreakpoint(boost::shared_ptr<ARL::Scripting::DebuggerBreakpoint> breakpoint);
...
private:
	void onBreakpointPropertyChanged(const ARL::Reflection::PropertyDescriptor* pPropertyDescriptor);
...
public:
	...
	void addBreakpoint(boost::shared_ptr<ARL::Scripting::DebuggerBreakpoint> breakpoint);
	void removeBreakpoint(boost::shared_ptr<ARL::Scripting::DebuggerBreakpoint> breakpoint);
...
private:
	BreakpointItem* findBreakpointItem(boost::shared_ptr<ARL::Scripting::DebuggerBreakpoint> breakpoint);
...
{
public:
	WatchItem(boost::shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
	~WatchItem();

	void updateWatchValue();
	bool hasWatch(boost::shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
...
private:
	void onWatchPropertyChanged(const ARL::Reflection::PropertyDescriptor* pPropertyDescriptor);
	void onScriptAncestryChanged(shared_ptr<ARL::Instance> newParent);
	void removeChildren();
...
public:
	...
	void addWatch(boost::shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
	void removeWatch(boost::shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
...
private:
	...
	WatchItem* findWatchItem(boost::shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
...
public:
	...
	void addWatch(shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
	void removeWatch(shared_ptr<ARL::Scripting::DebuggerWatch> spWatch);
...
public:
	...
	void showToolTip(const QPoint& pos, const QString &key, const ARL::Reflection::Variant &value);
	void hideToolTip();
...
private:
	...
	QString                         m_Key;
	ARL::Reflection::Variant        m_Value;
};
