...
RobloxDiagnosticsViewItem::RobloxDiagnosticsViewItem(boost::shared_ptr<ARL::Stats::Item> pItem)
: m_pItem(pItem)
{
...
void RobloxDiagnosticsViewItem::onChildAdded(boost::shared_ptr<ARL::Instance> child)
{
	if(!child)
		return;
...
void RobloxDiagnosticsViewItem::onChildRemoved(boost::shared_ptr<ARL::Instance> inst)
{
	if(!inst)
		return;
...
void RobloxDiagnosticsView::setDataModel(boost::shared_ptr<ARL::DataModel> pDataModel)
{
...
boost::shared_ptr<ARL::DataModel> RobloxDiagnosticsView::dataModel()
{	return m_pDataModel; }
...
void RobloxDiagnosticsView::onChildAdded(boost::shared_ptr<ARL::Instance> child)
{
	if(!child)
		return;
...
void RobloxDiagnosticsView::onChildRemoved(boost::shared_ptr<ARL::Instance> child)
{
	if(!child)
		return;
