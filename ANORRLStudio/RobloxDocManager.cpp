...
bool RobloxDocManager::requestCloseAllDocs()
{
    ...
    {
        ARL::BaldPtr<IRobloxDoc> doc = m_KeyDocMap.begin().value();
 ...
 */
IRobloxDoc* RobloxDocManager::getOrCreateDoc(IRobloxDoc::ARLDocType docType)
{
	ARL::BaldPtr<IRobloxDoc> pDoc = NULL;
...
void RobloxDocManager::openDoc(shared_ptr<ARL::Instance> script, int lineNumber)
{
...
void RobloxDocManager::updateWindowMenu()
{
    ...
    {
        ARL::BaldPtr<IRobloxDoc> doc = iter.value();
