...
public:
	...
	ANORRLMainWindow& getMainWindow() const	{ return *m_pANORRLMainWindow; }
	...
	ANORRLPlayersWidget* getPlayersWidget();
...
private:
	...
	void shutDown();
	void init(ANORRLMainWindow *pMainWindow);
	void initDocks();
	...
	ANORRLMainWindow*       m_pANORRLMainWindow;
	...
	QPointer<ANORRLPlayersWidget>       m_PlayersWidget;
	...
	//define ANORRLMainWindow as friend
	friend class ANORRLMainWindow;
};
