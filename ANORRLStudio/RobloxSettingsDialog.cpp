...
void RobloxSettingsDialog::onDescendantAdded(boost::shared_ptr<ARL::Instance> child)
{
	if(!child)
		return;
...
bool RobloxSettingsDialog::hasProperties(const ARL::Reflection::ClassDescriptor* pClassDescriptor)
{
	if(!pClassDescriptor)
		return false;
...
void RobloxSettingsDialog::onDescendantRemoving(boost::shared_ptr<ARL::Instance> child)
{
	if(!child)
		return;
