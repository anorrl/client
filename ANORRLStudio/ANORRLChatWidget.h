...
class ANORRLChatWidget: public QFrame
{
	Q_OBJECT
public:
	ANORRLChatWidget(QWidget* parent, boost::shared_ptr<ARL::DataModel> dataModel, boost::shared_ptr<PlayersDataManager> playerDataManager);
...
private:
	...
	void onPlayerChatMessage(const ARL::Network::ChatMessage& chatMessage);
