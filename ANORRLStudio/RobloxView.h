...
class RobloxView : public QObject, public ARL::IMetric
{
    Q_OBJECT
...
public:
	...
	RobloxView(QOgreWidget *pQtWrapperWidget, boost::shared_ptr<ARL::Game> game, boost::shared_ptr<ARL::ViewBase> view, bool vr = false);
