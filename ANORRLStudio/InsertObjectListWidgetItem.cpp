...
{
	setIcon(QIcon(QtUtilities::getPixmap(":/images/ClassImages.PNG", ANORRLTreeWidgetItem::getImageIndex(m_instance))));
	setText(name);
...
bool InsertObjectListWidgetItem::checkFilter(QString &filterString, ARL::Instance* pParent)
{
