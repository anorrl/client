...
void *PasteVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< PasteVerb*>(this));
...
void *DuplicateSelectionVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::EditSelectionVerb"))
        return static_cast< ARL::EditSelectionVerb*>(const_cast< DuplicateSelectionVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *CreateNewLinkedSourceVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< CreateNewLinkedSourceVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *ScreenshotVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< ScreenshotVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *OpenToolBoxWithOptionsVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< OpenToolBoxWithOptionsVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *RecordToggleVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< RecordToggleVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *ExportSelectionVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< ExportSelectionVerb*>(this));
    return QObject::qt_metacast(_clname);
}
...
void *ExportPlaceVerb::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ARL::Verb"))
        return static_cast< ARL::Verb*>(const_cast< ExportPlaceVerb*>(this));
    return QObject::qt_metacast(_clname);
}
