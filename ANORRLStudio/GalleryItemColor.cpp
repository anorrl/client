...
{
	std::vector<ARL::BrickColor>::const_iterator iter = ARL::BrickColor::colorPalette().begin();
	while (iter != ARL::BrickColor::colorPalette().end())
	{
...
GalleryItemColor::GalleryItemColor(const ARL::BrickColor& color)
: m_brickColor(color)
{
