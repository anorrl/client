...
class RobloxScriptReview::ScriptPerfUpdateJob : public ARL::DataModelJob
{
public:
	...
	ScriptPerfUpdateJob(RobloxScriptReview* scriptReview, boost::shared_ptr<ARL::DataModel> dataModel)
		:ARL::DataModelJob("RobloxScriptReview", ARL::DataModelJob::Read, false, dataModel, ARL::Time::Interval(0)),
...
void RobloxScriptReview::setDataModel(boost::shared_ptr<ARL::DataModel> pDataModel)
{
...
void RobloxScriptReview::AddValue(const ARL::Reflection::Variant& value)
{
...
void RobloxScriptReview::createUpdateItemsJob(boost::shared_ptr<ARL::DataModel> dataModel)
{
