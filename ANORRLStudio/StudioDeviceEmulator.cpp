...
void StudioDeviceEmulator::activateCurrentDevice()
{
	...
	if( ARL::UserInputService* userInputService = ARL::ServiceProvider::find<ARL::UserInputService>(ide->getDataModel()) )
...
void StudioDeviceEmulator::addEmulationChildren(ANORRLRibbonMainWindow* mainWindow, QObject* pParent)
{
