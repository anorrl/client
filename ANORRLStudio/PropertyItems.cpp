...
//formatting code from Client/ANORRL/PropGrid.cpp
...
public:
	...
	bool canModifyValue()
	{
		...
		{
			if (!ANORRLSettings().value(kLoadStringEnabledDialogDisabled, false).toBool())
			{
				...
				if (msgBox.getCheckBoxState())
					ANORRLSettings().setValue(kLoadStringEnabledDialogDisabled, true);
