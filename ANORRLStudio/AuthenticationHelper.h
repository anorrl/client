...
private:
	...
	// WinINet auth
	QString doHttpGetRequest(const QString& url, const ARL::HttpAux::AdditionalHeaders& externalHeaders = ARL::HttpAux::AdditionalHeaders());
	...
	QString getHttpRequest(const QString& urlString, const ARL::HttpAux::AdditionalHeaders& externalHeaders = ARL::HttpAux::AdditionalHeaders());
