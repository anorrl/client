...
bool DebuggerClientManager::handleAction(const QString &actionID, bool checkedState)
{
	if (FFlag::LuaDebuggerBreakOnError)
	{
		if (actionID == "neverBreakOnScriptErrorsAction")
		{
			...
			RobloxSettings().setValue(kBreakOnErrorModeSetting, (int)ARL::Scripting::BreakOnErrorMode_Never);
			return true;
		}
		...
		if (actionID == "breakOnAllScriptErrorsAction")
		{
			...
			RobloxSettings().setValue(kBreakOnErrorModeSetting, (int)ARL::Scripting::BreakOnErrorMode_AllExceptions);
			return true;
		}
		...
		if (actionID == "breakOnUnhandledScriptErrorsAction")
		{
			...
			RobloxSettings().setValue(kBreakOnErrorModeSetting, (int)ARL::Scripting::BreakOnErrorMode_UnhandledExceptions);
			return true;
		}
	}
	...
	if (!breakOnErrorSet)
		{
			...
			if (msgBox.getClickedYes())
			{
				...
				RobloxSettings().setValue(kBreakOnErrorModeSetting, (int)ARL::Scripting::DebuggerManager::singleton().getBreakOnErrorMode());
			}
			else
			{
				ARL::Scripting::DebuggerManager::singleton().setBreakOnErrorMode(ARL::Scripting::BreakOnErrorMode_Never);
