...
class ANORRLMouseConfig
{
public:
    ANORRLMouseConfig();
    
    static ANORRLMouseConfig& singleton();
    ...
    bool canOpenContextMenu(ARL::InputObject::UserInputType inputType,
...
class ANORRLMouseConfigWidget : public QWidget
{
    Q_OBJECT
public:
    ANORRLMouseConfigWidget(QWidget* parent = 0);
