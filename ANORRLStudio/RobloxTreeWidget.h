...
struct DepthCompare
{
	bool operator() (const RobloxTreeWidgetItem* lhs, const RobloxTreeWidgetItem* rhs);
};
...
typedef std::map<const ARL::Instance*, RobloxTreeWidgetItem*> InstanceMap;
...
public:
	...
	RobloxTreeWidgetItem* processChildAdd(shared_ptr<ARL::Instance> pInstance);
...
class RobloxTreeWidgetItem: public QObject, public QTreeWidgetItem, public InstanceUpdateHandler
{
    Q_OBJECT
public:
	RobloxTreeWidgetItem(int index, RobloxTreeWidget *pTreeWidget, boost::shared_ptr<ARL::Instance> pInstance);	
	RobloxTreeWidgetItem(int index, RobloxTreeWidgetItem *pParentWidgetItem, boost::shared_ptr<ARL::Instance> pInstance);
...
class RobloxTreeWidget : public QTreeWidget, public InstanceUpdateHandler
{
	Q_OBJECT
public:
	RobloxTreeWidget(boost::shared_ptr<ARL::DataModel> pDataModel);
	...
	void addInstance(const ARL::Instance *pInstance, RobloxTreeWidgetItem *pTreeWidgetItem);
	void eraseInstance(ARL::Instance *pInstance);
	RobloxTreeWidgetItem* findItemFromInstance(const ARL::Instance *pInstance);
