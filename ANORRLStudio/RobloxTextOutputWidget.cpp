    ...
    : QPlainTextEdit(parent)
{
    ...
    connect(
        &Roblox::Instance(),SIGNAL(newOutputMessage(const QString,ARL::MessageType)), 
...
void RobloxTextOutputWidget::onPropertyChanged(const ARL::Reflection::PropertyDescriptor* pDescriptor)
{
 ...
 */
void RobloxTextOutputWidget::appendOutputText(const QString message,ARL::MessageType type)
{
