...
// RobloxChatWidget
//--------------------------------------------------------------------------------------------
RobloxChatWidget::RobloxChatWidget(QWidget* parent, boost::shared_ptr<ARL::DataModel> dataModel, boost::shared_ptr<PlayersDataManager> playerDataManager)
: QFrame(parent)
...
void RobloxChatWidget::onPlayerChatMessage(const ARL::Network::ChatMessage& chatMessage)
{
