...
static const char qt_meta_stringdata_ScriptAnalysisWidget[] = {
    ...
    "analyzeScriptAssetSource(QString,ARL::HttpFuture)\0"
    "script,result\0"
    "updateResultsInternal(shared_ptr<ARL::Instance>,ARL::ScriptAnalyzer::R"
    "esult)\0"
    "script\0analyzeAndUpdateResults(shared_ptr<ARL::Instance>)\0"
};
...
void ScriptAnalysisWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->analyzeScriptAssetSource((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< ARL::HttpFuture(*)>(_a[2]))); break;
        case 7: _t->updateResultsInternal((*reinterpret_cast< shared_ptr<ARL::Instance>(*)>(_a[1])),(*reinterpret_cast< const ARL::ScriptAnalyzer::Result(*)>(_a[2]))); break;
        case 8: _t->analyzeAndUpdateResults((*reinterpret_cast< shared_ptr<ARL::Instance>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
