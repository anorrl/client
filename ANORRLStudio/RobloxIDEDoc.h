...
struct GameState
{
    ...
    ARL::BaldPtr<RobloxView>        m_View;
    ARL::BaldPtr<RobloxTreeWidget>  m_TreeWidget;
...
public:
	...
	IRobloxDoc::ARLCloseRequest requestClose();

	IRobloxDoc::ARLDocType docType() { return IRobloxDoc::IDE; }
