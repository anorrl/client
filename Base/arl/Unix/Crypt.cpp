...
char publicKey[] = {
    "-----BEGIN PUBLIC KEY-----\n"
    "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDJBlGAuRN67KFRVjVbLZuvT5nS\n"
    "eabpGCc1J+lhv0NQvpvrkWSPeKO4/Nc9R9BA5Vh8ipvnhAOOg+sMo60QBx5k0FVm\n"
    "GSVYx8O/83Td8FZPMZAumvNaw+4Y/ls3W2lsqQMAsI4vvMM5J1IVgFjekU2Xk810\n"
    "WHBzvbLQM52GRAA8gQIDAQAB\n"
    "-----END PUBLIC KEY-----\n"
};
...
int verifyMessage(char* message, char* sig_b64)
{
    ...
    if (1 != rc)
        throw ARL::runtime_error("Error during SHA_Init");

    rc = SHA1_Update(&sha_ctx, (unsigned char*)message, strlen(message));
    if (1 != rc)
        throw ARL::runtime_error("Error during SHA_Update");

    rc = SHA1_Final(digest, &sha_ctx);
    if (1 != rc)
        throw ARL::runtime_error("Error during SHA_Final");
