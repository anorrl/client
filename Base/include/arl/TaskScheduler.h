...
{	
	...
	private:
        ...
        arl::atomic<int> runningJobCount;
        ...
        arl::atomic<int> threadCount;

		static arl::thread_specific_reference<TaskScheduler::Job> currentJob;
	...
	class SimpleThrottlingArbiter : public TaskScheduler::Arbiter
	{
        ...
        arl::atomic<int> updatingThrottle;
        static arl::atomic<int> arbiterCount;
