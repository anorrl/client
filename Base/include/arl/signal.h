		...
		*/
		...
		public:
			class islot 
				...
				//       saves 4 bytes.
				, public arl::intrusive_ptr_target<islot, unsigned short, 0, 0>
#else
				, public arl::intrusive_ptr_target<islot>
#endif
			{
			protected:
				islot()
		...
		private:
			...
			arl::intrusive_weak_ptr<islot> weak_slot;	// must be weak to avoid memory leaks
		};
		...
		public:
			...
			void flogPrint()
			{
				...
				boost::intrusive_ptr<typename arl::signals::signal<Signature>::slot> item;
		...
		public:
			void operator()()
			{
				if (this->empty()) return;
                 ...
                 typedef typename arl::signals::signal<Signature>::slot slot;
            ...
            begin:
				...
				{
					arl::signals::signal<Signature>::on_error(e);
