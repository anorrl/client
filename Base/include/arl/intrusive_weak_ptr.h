...
namespace arl
{
	/*
		...
		Note: arl::intrusive_ptr_target is a nice wrapper class that implements
	...
	*/
	...
	public:
		...
		inline intrusive_weak_ptr& operator=(const arl::intrusive_weak_ptr<T>& rhs)
		{
			reset(rhs.raw());
			return *this;
		}
	    ...
	    template<class U>
		inline intrusive_weak_ptr& operator=(const arl::intrusive_weak_ptr<U>& rhs)
		{
			reset(rhs.raw());
			return *this;
		}
