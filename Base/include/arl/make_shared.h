...
{
    boost::shared_ptr< T > pt( static_cast< T* >( 0 ), arl::detail::sp_ms_deleter< T >() );

    arl::detail::sp_ms_deleter< T > * pd = boost::get_deleter< arl::detail::sp_ms_deleter< T > >( pt );
...
{
    boost::shared_ptr< T > pt( static_cast< T* >( 0 ), arl::detail::sp_ms_deleter< T >(), a );
