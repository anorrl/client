...
#if defined( ARL_SIMD_X86 ) || defined( ARL_SIMD_X64 )
#define ARL_SIMD_USE_SSE
#elif defined( ARL_SIMD_ARM )
#define ARL_SIMD_USE_NEON
#endif

#ifdef ARL_SIMD_USE_SSE
#include <xmmintrin.h>
#include <emmintrin.h>
#include <mmintrin.h>
#endif

#ifdef ARL_SIMD_USE_NEON
#include <arm_neon.h>
#endif

#define ARL_SIMD_ALIGN_ASSERT( p, a ) ARLASSERT_VERY_FAST( ( ( uint64_t )( p ) & ( a - 1 ) ) == 0 )

#ifdef _MSC_VER
#define ARL_SIMD_INLINE __forceinline
#elif defined( __clang__ ) || defined( __GNUC__ )
#define ARL_SIMD_INLINE inline __attribute__((always_inline))
#else
#define ARL_SIMD_INLINE inline
#endif
