...
namespace details
{
    ARL_SIMD_INLINE v4f::pod_t load( const float* s )
    {
        return vld1q_f32( s );
    }

    ARL_SIMD_INLINE v4i::pod_t load( const int32_t* s )
    {
        return vld1q_s32( s );
    }
    
    ARL_SIMD_INLINE v4u::pod_t load( const uint32_t* s )
    {
        return vld1q_u32( s );
    }

    template< int Lane >
    ARL_SIMD_INLINE v4f::pod_t loadLane( const float* s, v4f::pod_t vec )
    {
        return vld1q_lane_f32( s, vec, Lane );
    }

    template< int Lane >
    ARL_SIMD_INLINE v4u::pod_t loadLane( const uint32_t* s, v4u::pod_t vec )
    {
        return vld1q_lane_u32( s, vec, Lane );
    }

    template< int Lane >
    ARL_SIMD_INLINE v4i::pod_t loadLane( const int32_t* s, v4i::pod_t vec )
    {
        return vld1q_lane_s32( s, vec, Lane );
    }

    ARL_SIMD_INLINE v4f::pod_t loadSplat( const float* s )
    {
        return vld1q_dup_f32( s );
    }

    ARL_SIMD_INLINE v4u::pod_t loadSplat( const uint32_t* s )
    {
        return vld1q_dup_u32( s );
    }

    ARL_SIMD_INLINE v4i::pod_t loadSplat( const int32_t* s )
    {
        return vld1q_dup_s32( s );
    }
    
    ARL_SIMD_INLINE float32x2_t loadD( const float* s )
    {
        return vld1_f32( s );
    }

    ARL_SIMD_INLINE int32x2_t loadD( const int32_t* s )
    {
        return vld1_s32( s );
    }

    ARL_SIMD_INLINE uint32x2_t loadD( const uint32_t* s )
    {
        return vld1_u32( s );
    }

    ARL_SIMD_INLINE float32x2_t loadSplatD( const float* s )
    {
        return vld1_dup_f32( s );
    }

    ARL_SIMD_INLINE int32x2_t loadSplatD( const int32_t* s )
    {
        return vld1_dup_s32( s );
    }

    ARL_SIMD_INLINE uint32x2_t loadSplatD( const uint32_t* s )
    {
        return vld1_dup_u32( s );
    }
    
    ARL_SIMD_INLINE float32x4_t combine( float32x2_t a, float32x2_t b )
    {
        return vcombine_f32( a, b );
    }

    ARL_SIMD_INLINE int32x4_t combine( int32x2_t a, int32x2_t b )
    {
        return vcombine_s32( a, b );
    }

    ARL_SIMD_INLINE uint32x4_t combine( uint32x2_t a, uint32x2_t b )
    {
        return vcombine_u32( a, b );
    }

    template< class Type >
    ARL_SIMD_INLINE typename Type::pod_t zero();
    
    template< >
    ARL_SIMD_INLINE v4f::pod_t zero< v4f >()
    {
    ...
    template< >
    ARL_SIMD_INLINE v4i::pod_t zero< v4i >()
    {
    ...
    template< >
    ARL_SIMD_INLINE v4u::pod_t zero< v4u >()
    {
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > load( const ScalarType* s )
{
    ARL_SIMD_ALIGN_ASSERT( s, 16 );
    v4< ScalarType > r;
    r.v = details::load( s );
    return r;
}
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > loadUnaligned( const ScalarType* s )
{
    v4< ScalarType > r;
    r.v = details::load( s );
    return r;
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > loadSingle( const ScalarType* s )
{
    v4< ScalarType > r;
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > loadSplat( const ScalarType* s )
{
    v4< ScalarType > r;
...
ARL_SIMD_INLINE v4f load3( const float* value )
{
...
namespace details
{
    ARL_SIMD_INLINE void store( float* s, float32x4_t v )
    {
        vst1q_f32( s, v );
    }

    ARL_SIMD_INLINE void store( int32_t* s, int32x4_t v )
    {
        vst1q_s32( s, v );
    }

    ARL_SIMD_INLINE void store( uint32_t* s, uint32x4_t v )
    {
        vst1q_u32( s, v );
    }

    template< int lane >
    ARL_SIMD_INLINE void storeLane( float* s, float32x4_t v )
    {
        vst1q_lane_f32( s, v, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE void storeLane( int32_t* s, int32x4_t v )
    {
        vst1q_lane_s32( s, v, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE void storeLane( uint32_t* s, uint32x4_t v )
    {
...
template< class ScalarType >
ARL_SIMD_INLINE void store( ScalarType* dst, const v4< ScalarType >& v )
{
    ARL_SIMD_ALIGN_ASSERT( dst, 16 );
    details::store( dst, v.v );
}

template< class ScalarType >
ARL_SIMD_INLINE void storeUnaligned( ScalarType* dst, const v4< ScalarType >& v )
{
    details::store( dst, v.v );
}

template< class ScalarType >
ARL_SIMD_INLINE void storeSingle( ScalarType* dst, const v4< ScalarType >& v )
{
...
namespace details
{
    ARL_SIMD_INLINE float32x4_t splat( float s )
    {
        return vdupq_n_f32( s );
    }

    ARL_SIMD_INLINE int32x4_t splat( int32_t s )
    {
        return vdupq_n_s32( s );
    }

    ARL_SIMD_INLINE uint32x4_t splat( uint32_t s )
    {
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > splat( ScalarType s )
{
    v4< ScalarType > r;
    r.v = details::splat( s );
    return r;
...
namespace details
{
    ARL_SIMD_INLINE float32x2_t splatD( float s )
    {
        return vmov_n_f32( (s) );
    }

    ARL_SIMD_INLINE int32x2_t splatD( int32_t s )
    {
        return vmov_n_s32( (s) );
    }

    ARL_SIMD_INLINE uint32x2_t splatD( uint32_t s )
    {
        return vmov_n_u32( (s) );
    }
    
    ARL_SIMD_INLINE float32x2_t zip1( float32x2_t a, float32x2_t b )
    {
        return vzip_f32( a, b ).val[ 0 ];
    }

    ARL_SIMD_INLINE int32x2_t zip1( int32x2_t a, int32x2_t b )
    {
        return vzip_s32( a, b ).val[ 0 ];
    }

    ARL_SIMD_INLINE uint32x2_t zip1( uint32x2_t a, uint32x2_t b )
    {
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > form( ScalarType x, ScalarType y, ScalarType z, ScalarType w )
{
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > form( ScalarType x, ScalarType y, ScalarType z )
{
    typename details::v2< ScalarType >::pod_t vx = details::splatD( x );
    typename details::v2< ScalarType >::pod_t vy = details::splatD( y );
    typename details::v2< ScalarType >::pod_t vxy = details::zip1( vx, vy );
...
template< class ScalarType >
ARL_SIMD_INLINE v4< ScalarType > form( ScalarType x, ScalarType y )
{
    typename details::v2< ScalarType >::pod_t vx = details::splatD( x );
    typename details::v2< ScalarType >::pod_t vy = details::splatD( y );
    typename details::v2< ScalarType >::pod_t vxy = details::zip1( vx, vy );
...
ARL_SIMD_INLINE typename VectorType::elem_t extractSlow( const VectorType& _v, uint32_t _i )
{
    union
    {
...
//
ARL_SIMD_INLINE v4u reinterpretAsUInt( v4fArg v )
{
    v4u r;
...
ARL_SIMD_INLINE v4i reinterpretAsInt( v4fArg v )
{
    v4i r;
...
ARL_SIMD_INLINE v4f reinterpretAsFloat( v4uArg v )
{
    v4f r;
...
ARL_SIMD_INLINE v4f reinterpretAsFloat( v4iArg v )
{
    v4f r;
...
ARL_SIMD_INLINE v4u reinterpretAsUInt( v4iArg v )
{
    v4u r;
...
ARL_SIMD_INLINE v4i reinterpretAsInt( v4uArg v )
{
    v4i r;
...
ARL_SIMD_INLINE v4i convertFloat2IntNearest( v4fArg v )
{
...
ARL_SIMD_INLINE v4i convertFloat2IntTruncate( v4fArg v )
{
    v4i r;
...
ARL_SIMD_INLINE v4f convertIntToFloat( v4iArg v )
{
    v4f r;
...
namespace details
{
    ARL_SIMD_INLINE float32x2_t low( float32x4_t t )
    {
        return vget_low_f32( t );
    }

    ARL_SIMD_INLINE int32x2_t low( int32x4_t t )
    {
        return vget_low_s32( t );
    }

    ARL_SIMD_INLINE uint32x2_t low( uint32x4_t t )
    {
        return vget_low_u32( t );
    }

    ARL_SIMD_INLINE float32x2_t high( float32x4_t t )
    {
        return vget_high_f32( t );
    }

    ARL_SIMD_INLINE int32x2_t high( int32x4_t t )
    {
        return vget_high_s32( t );
    }

    ARL_SIMD_INLINE uint32x2_t high( uint32x4_t t )
    {
        return vget_high_u32( t );
    }
    
    template< int lane >
    ARL_SIMD_INLINE float32x4_t splat( float32x2_t a )
    {
        return vdupq_lane_f32( a, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE int32x4_t splat( int32x2_t a )
    {
        return vdupq_lane_s32( a, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE uint32x4_t splat( uint32x2_t a )
    {
        return vdupq_lane_u32( a, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE float32x2_t splatD( float32x2_t a )
    {
        return vdup_lane_f32( a, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE int32x2_t splatD( int32x2_t a )
    {
        return vdup_lane_s32( a, lane );
    }

    template< int lane >
    ARL_SIMD_INLINE uint32x2_t splatD( uint32x2_t a )
    {
    ...
    {
        static ARL_SIMD_INLINE VectorType splat( const VectorType& v )
        {
        ...
        static ARL_SIMD_INLINE v2< typename VectorType::elem_t > splatD( const VectorType& v )
        {
...
ARL_SIMD_INLINE VectorType splat( const VectorType& v )
{
...
namespace details
{
    ARL_SIMD_INLINE float32x2_t selectD( float32x2_t u, float32x2_t v, uint32x2_t s )
    {
        return vbsl_f32( s, v, u );
    }

    ARL_SIMD_INLINE int32x2_t selectD( int32x2_t u, int32x2_t v, uint32x2_t s )
    {
        return vbsl_s32( s, v, u );
    }

    ARL_SIMD_INLINE uint32x2_t selectD( uint32x2_t u, uint32x2_t v, uint32x2_t s )
    {
        return vbsl_u32( s, v, u );
    }
    
    ARL_SIMD_INLINE uint8x8_t castToUInt8( float32x2_t v )
    {
        return vreinterpret_u8_f32( v );
    }

    ARL_SIMD_INLINE uint8x8_t castToUInt8( uint32x2_t v )
    {
        return vreinterpret_u8_u32( v );
    }

    ARL_SIMD_INLINE uint8x8_t castToUInt8( int32x2_t v )
    {
        return vreinterpret_u8_s32( v );
    }

    template< class From >
    ARL_SIMD_INLINE uint8x8x2_t castToUInt8x2( From v )
    {
        uint8x8x2_t r;
    ...
    template< class From >
    ARL_SIMD_INLINE uint8x8x4_t castToUInt8x4( From u, From v )
    {
        uint8x8x4_t r;
    ...
    {
        static ARL_SIMD_INLINE float32x4_t cast( uint8x8x2_t v )
        {
        ...
        static ARL_SIMD_INLINE float32x2_t cast( uint8x8_t v )
        {
    ...
    {
        static ARL_SIMD_INLINE uint32x4_t cast( uint8x8x2_t v )
        {
        ...
        static ARL_SIMD_INLINE uint32x2_t cast( uint8x8_t v )
        {
    ...
    {
        static ARL_SIMD_INLINE int32x4_t cast( uint8x8x2_t v )
        {
        ...
        static ARL_SIMD_INLINE int32x2_t cast( uint8x8_t v )
        {
    ...
    ARL_SIMD_INLINE uint32x2_t selectMaskD()
    {
...
ARL_SIMD_INLINE v4u selectMask()
{
...
template< class VectorType >
ARL_SIMD_INLINE VectorType select( const VectorType& a, const VectorType& b, const v4u& mask )
{
    VectorType r;
...
#define ARL_SIMD_NEON_TBL_MASK( a ) ( ( 4 * ( a ) ) | ( ( 4 * ( a ) + 1 ) << 8 ) | ( ( 4 * ( a ) + 2 ) << 16 ) | ( ( 4 * ( a ) + 3 ) << 24 ) )

namespace details
{
    template< uint32_t a, uint32_t b, class VectorType >
    ARL_SIMD_INLINE typename details::v2< typename VectorType::elem_t >::pod_t chooseTwoElements( const VectorType& u )
    {
        uint8x8x2_t u8 = details::castToUInt8x2( u.v );
        uint64_t lowMask = uint64_t( ARL_SIMD_NEON_TBL_MASK( a ) ) | ( uint64_t( ARL_SIMD_NEON_TBL_MASK( b ) ) << 32 );
        return details::CastFromUInt8< typename VectorType::pod_t >::cast( vtbl2_u8( u8, vcreate_u8(lowMask) ) );
    }

    template< uint32_t a, uint32_t b, class VectorType >
    ARL_SIMD_INLINE typename details::v2< typename VectorType::elem_t >::pod_t chooseTwoElements( const VectorType& u, const VectorType& v )
    {
...
ARL_SIMD_INLINE VectorType shuffle( const VectorType& u, const VectorType& v )
{
    VectorType r;
...
namespace details
{
    ARL_SIMD_INLINE float32x4_t zipLow( float32x4_t a, float32x4_t b )
    {
        float32x2x2_t t = vzip_f32( low(a), low(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE uint32x4_t zipLow( uint32x4_t a, uint32x4_t b )
    {
        uint32x2x2_t t = vzip_u32( low(a), low(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE int32x4_t zipLow( int32x4_t a, int32x4_t b )
    {
        int32x2x2_t t = vzip_s32( low(a), low(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE float32x4_t zipHigh( float32x4_t a, float32x4_t b )
    {
        float32x2x2_t t = vzip_f32( high(a), high(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE uint32x4_t zipHigh( uint32x4_t a, uint32x4_t b )
    {
        uint32x2x2_t t = vzip_u32( high(a), high(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE int32x4_t zipHigh( int32x4_t a, int32x4_t b )
    {
        int32x2x2_t t = vzip_s32( high(a), high(b) );
        return combine( t.val[0], t.val[1] );
    }

    ARL_SIMD_INLINE float32x4x2_t zip( float32x4_t a, float32x4_t b )
    {
        return vzipq_f32( a, b );
    }

    ARL_SIMD_INLINE uint32x4x2_t zip( uint32x4_t a, uint32x4_t b )
    {
        return vzipq_u32( a, b );
    }

    ARL_SIMD_INLINE int32x4x2_t zip( int32x4_t a, int32x4_t b )
    {
...
template< class VectorType >
ARL_SIMD_INLINE VectorType zipLow( const VectorType& u, const VectorType& v )
{
    return VectorType( details::zipLow( u.v, v.v ) );
}

template< class VectorType >
ARL_SIMD_INLINE VectorType zipHigh( const VectorType& u, const VectorType& v )
{
    return VectorType( details::zipHigh( u.v, v.v ) );
}

template< class VectorType >
ARL_SIMD_INLINE void zip( VectorType& r0, VectorType& r1, const VectorType& u, const VectorType& v )
{
...
template< class VectorType >
ARL_SIMD_INLINE VectorType moveHighLow( const VectorType& u, const VectorType& v )
{
    VectorType r;
...
template< class VectorType >
ARL_SIMD_INLINE VectorType moveLowHigh( const VectorType& u, const VectorType& v )
{
    VectorType r;
...
namespace details
{
    ...
    struct SelectHelper
    {
        static ARL_SIMD_INLINE T select( const T& u, const T& v )
        {
...
ARL_SIMD_INLINE T select( const T& u, const T& v )
{
    return details::SelectHelper< T, a, b, c, d >::select( u, v );
}

template< uint32_t index, class T >
ARL_SIMD_INLINE T replace( const T& a, const T& b )
{
...
//
template< uint32_t a, uint32_t b, uint32_t c, uint32_t d, class VectorType >
ARL_SIMD_INLINE VectorType permute( const VectorType& u )
{
    VectorType r;
...
ARL_SIMD_INLINE T rotateLeft( const T& v )
{
...
// Compares
//
ARL_SIMD_INLINE v4u compareGreater( v4fArg a, v4fArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u operator>( v4fArg a, v4fArg b )
{
    v4u r;
    r.v = vcgtq_f32( a.v, b.v );
    return r;
...
ARL_SIMD_INLINE v4u compareGreaterEqual( v4fArg a, v4fArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u compareLess( v4fArg a, v4fArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u compareLessEqual( v4fArg a, v4fArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u compare( v4fArg a, v4fArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u compare( v4iArg a, v4iArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u operator==( v4iArg a, v4iArg b )
{
    v4u r;
    r.v = vceqq_s32( a.v, b.v );
    return r;
...
ARL_SIMD_INLINE v4u compare( v4uArg a, v4uArg b )
{
    v4u r;
...
ARL_SIMD_INLINE v4u operator==( v4uArg a, v4uArg b )
{
    v4u r;
    r.v = vceqq_u32( a.v, b.v );
    return r;
...
//
template< uint32_t a >
ARL_SIMD_INLINE v4f replaceWithZero( v4fArg v )
{
...
template< uint32_t a >
ARL_SIMD_INLINE v4i replaceWithZero( v4iArg v )
{
    BOOST_STATIC_ASSERT_MSG( ( a & 0x3 ) == a, "a must be between 0 and 3" );
    v4i r;
...
template< uint32_t a >
ARL_SIMD_INLINE v4u replaceWithZero( v4uArg v )
{
    BOOST_STATIC_ASSERT_MSG( ( a & 0x3 ) == a, "a must be between 0 and 3" );
    v4u r;
...
// Float Arithmetics
//
ARL_SIMD_INLINE v4f operator+( v4fArg a, v4fArg b )
{
    v4f r;
...
ARL_SIMD_INLINE v4f& operator+=( v4f& a, v4fArg b )
{
...
ARL_SIMD_INLINE v4f mulAdd( v4fArg a, v4fArg b, v4fArg c )
{
    v4f r;
...
ARL_SIMD_INLINE v4f operator-( v4fArg a )
{
    v4f r;
    r.v = vnegq_f32( a.v );
    return r;
...
ARL_SIMD_INLINE v4f abs( v4fArg a )
{
    v4f r;
    r.v = vabsq_f32( a.v );
    return r;
...
namespace details
{
    ARL_SIMD_INLINE v4f inverseEstimateIteration(const v4f& a, const v4f& estimate)
    {
        return estimate * v4f( vrecpsq_f32( a.v, estimate.v ) );
    }
}

ARL_SIMD_INLINE v4f inverseEstimate0Fast( v4fArg a )
{
...
ARL_SIMD_INLINE v4f inverseEstimate0( v4fArg a )
{
    v4f estimate = v4f(vrecpeq_f32( a.v ));
    v4f estimate1 = details::inverseEstimateIteration(a, estimate);
...
ARL_SIMD_INLINE v4f inverseEstimate1Fast( v4fArg a )
{
    v4f estimate = v4f(vrecpeq_f32( a.v ));
    v4f estimate1 = details::inverseEstimateIteration(a, estimate);
...
ARL_SIMD_INLINE v4f inverseEstimate1( v4fArg a )
{
    v4f estimate = v4f(vrecpeq_f32( a.v ));
    v4f estimate1 = details::inverseEstimateIteration(a, estimate);
    estimate1 = details::inverseEstimateIteration(a, estimate1);
...
ARL_SIMD_INLINE v4f smallestInvertible( )
{
...
ARL_SIMD_INLINE v4f largestInvertible( )
{
...
namespace details
{
    ARL_SIMD_INLINE v4f inverseSqrtIteration(const v4f& v, const v4f& estimate) 
    {
...
ARL_SIMD_INLINE v4f inverseSqrtEstimate0( v4fArg a )
{
...
ARL_SIMD_INLINE v4f inverseSqrtEstimate0Fast( v4fArg a )
{
    v4f estimate( vrsqrteq_f32( a.v ) );
...
ARL_SIMD_INLINE v4f inverseSqrtEstimate1( v4fArg a )
{
    v4f estimate( vrsqrteq_f32( a.v ) );
    v4f estimate1 = details::inverseSqrtIteration(a, estimate);
...
ARL_SIMD_INLINE v4f inverseSqrtEstimate1Fast(const v4f& v) 
{
...
ARL_SIMD_INLINE v4f smallestSqrtInvertible( )
{
    return splat( 1.4012985e-45f );
}

ARL_SIMD_INLINE v4f largestSqrtInvertible( )
{
    // This is the same as std::numeric_limints< float >::max()
    return splat( 3.40282347E+38f );
}

ARL_SIMD_INLINE v4f max( v4fArg a, v4fArg b )
{
    v4f r;
...
ARL_SIMD_INLINE v4f min( v4fArg a, v4fArg b )
{
    v4f r;
...
//
ARL_SIMD_INLINE v4f dotProduct( v4fArg a, v4fArg b )
{
...
ARL_SIMD_INLINE v4f dotProduct3( v4fArg a, v4fArg b )
{
    float32x4_t p0123 = vmulq_f32( a.v, b.v );
...
ARL_SIMD_INLINE v4f sumAcross( v4fArg a )
{
...
ARL_SIMD_INLINE v4f sumAcross2( v4fArg a, v4fArg b )
{
...
ARL_SIMD_INLINE v4f sumAcross3( v4fArg a, v4fArg b )
{
...
ARL_SIMD_INLINE v4f sumAcross4( v4fArg a, v4fArg b )
{
    float32x2x2_t t01 = vtrn_f32( details::low( a.v ), details::low( b.v ) );
...
{
    template< class T >
    ARL_SIMD_INLINE T moveHigh( const T& a, const T& b )
    {
        return details::combine( details::low( a ), details::high( b ) );
    }

    template< class T >
    ARL_SIMD_INLINE T moveLow( const T& a, const T& b )
    {
...
template< class T >
ARL_SIMD_INLINE void pack3( typename T::pod_t* __restrict p, const T& a, const T& b, const T& c, const T& d )
{
...
template< class T >
ARL_SIMD_INLINE void unpack3( T& a, T& b, T& c, T& d, const typename T::pod_t* p )
{
    a = p[0];
