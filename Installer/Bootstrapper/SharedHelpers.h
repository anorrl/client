...
// Version URL string names (setup.anorrl.com/XXX) - replace XXX with these values to get the most recent version
...
void updateExistingANORRLShortcuts(simple_logger<wchar_t> &logger, bool isPerUser, const TCHAR *folder, const TCHAR *exeName, const TCHAR *exeFolderPath, const TCHAR *baseFolderPath);
