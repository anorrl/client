...
/* at Wed Apr 22 22:04:17 2026
 */
/* Compiler settings for ANORRLProxy.idl:
...
typedef struct _ANORRLProxy_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ANORRLProxy_MIDL_TYPE_FORMAT_STRING;

typedef struct _ANORRLProxy_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ANORRLProxy_MIDL_PROC_FORMAT_STRING;

typedef struct _ANORRLProxy_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ANORRLProxy_MIDL_EXPR_FORMAT_STRING;
...
extern const ANORRLProxy_MIDL_TYPE_FORMAT_STRING ANORRLProxy__MIDL_TypeFormatString;
extern const ANORRLProxy_MIDL_PROC_FORMAT_STRING ANORRLProxy__MIDL_ProcFormatString;
extern const ANORRLProxy_MIDL_EXPR_FORMAT_STRING ANORRLProxy__MIDL_ExprFormatString;
...
static const ANORRLProxy_MIDL_PROC_FORMAT_STRING ANORRLProxy__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ANORRLProxy_MIDL_TYPE_FORMAT_STRING ANORRLProxy__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ILauncher_ProxyInfo =
    {
    &Object_StubDesc,
    ANORRLProxy__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ANORRLProxy__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _ANORRLProxy_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ILauncherProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _ANORRLProxy_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ILauncherStubVtbl,
    0
};

PCInterfaceName const _ANORRLProxy_InterfaceNamesList[] = 
{
    "ILauncher",
    0
};

const IID *  const _ANORRLProxy_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _ANORRLProxy_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ANORRLProxy, pIID, n)

int __stdcall _ANORRLProxy_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_ANORRLProxy_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo ANORRLProxy_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ANORRLProxy_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ANORRLProxy_StubVtblList,
    (const PCInterfaceName * ) & _ANORRLProxy_InterfaceNamesList,
    (const IID ** ) & _ANORRLProxy_BaseIIDList,
    & _ANORRLProxy_IID_Lookup, 
    1,
    2,
