...
class ATL_NO_VTABLE CLauncher :
	...
	public IProvideClassInfo2Impl<&CLSID_Launcher, NULL, &LIBID_ANORRLProxyLib>,
	public IObjectSafetySiteLockImpl<CLauncher, INTERFACESAFE_FOR_UNTRUSTED_CALLER>,
	public IDispatchImpl<ILauncher, &IID_ILauncher, &LIBID_ANORRLProxyLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
	...
	std::wstring getLowLogName()
	{
		...
		GUID g = {0};
		::CoCreateGuid(&g);
		return format_string(_T("%sARL-%08X.%s"), basePath.c_str(), g.Data1, _T("log"));
	}
	...
	HRESULT ResetState()
	{
		...
		swprintf(guidString, MAX_PATH, _T("ARL-%d-%d-%d-%d%d%d%d%d%d%d%d"), g1.Data1, g1.Data2, g1.Data3, g1.Data4[0], g1.Data4[1], g1.Data4[2], g1.Data4[3], g1.Data4[4], g1.Data4[5], g1.Data4[6], g1.Data4[7]);
		...
		GUID g2 = {0};
		hr = CoCreateGuid(&g2);
		swprintf(unhideEventName, MAX_PATH, _T("ARL-%d-%d-%d-%d%d%d%d%d%d%d%d"), g2.Data1, g2.Data2, g2.Data3, g2.Data4[0], g2.Data4[1], g2.Data4[2], g2.Data4[3], g2.Data4[4], g2.Data4[5], g2.Data4[6], g2.Data4[7]);
