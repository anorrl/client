...
void CLauncher::logsCleanUpHelper()
{
	...
	for (size_t i = 0;i < folders.size();i ++) 
	{
		...
		handle = FindFirstFile((folders[i] + _T("ARL*.log")).c_str(), &findFileData);
...
const CLauncher::SiteList CLauncher::rgslTrustedSites[] =
{
	...
	{ SiteList::Allow, L"http", L"anorrllabs.com" },
	{ SiteList::Allow, L"https", L"lambda.com"},
	{ SiteList::Allow, L"https", L"anorrllabs.com" }
...
{
	::MessageBox(NULL, _T("Hello World"), _T("ANORRL Proxy"), MB_OK);
...
STDMETHODIMP CLauncher::BringAppToFront()
{
	...
	const TCHAR *mainWndStorageName = _T("ARLMAINWND-4DAAC10B-9C9A-4471-9218-07310329FD0D");
