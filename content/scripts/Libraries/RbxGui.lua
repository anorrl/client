...
t.CreateStyledMessageDialog = function(title, message, style, buttons)
	...
	if style == "error" or style == "Error" then
		...
		styleImage.Image = "http://www.anorrl.com/asset/?id=42565285"
	elseif style == "notify" or style == "Notify" then
		styleImage.Size = UDim2.new(0, 71, 0, 71)
		styleImage.Image = "http://www.anorrl.com/asset/?id=42604978"
	elseif style == "confirm" or style == "Confirm" then
		styleImage.Size = UDim2.new(0, 74, 0, 76)
		styleImage.Image = "http://www.anorrl.com/asset/?id=42557901"
	else
...
t.CreateDropDownMenu = function(items, onSelect, forRoblox, whiteSkin, baseZ)
	...
	if (whiteSkin) then
		...
		dropDownIcon.Image = "http://www.anorrl.com/asset/?id=45732894"
...
t.CreateScrollingFrame = function(orderList,scrollStyle)
	...
	scrollDrag.Image = "http://www.anorrl.com/asset/?id=61367186"
...
t.CreateSetPanel = function(userIdsForSets, objectSelected, dialogClosed, size, position, showAdminCategories, useAssetVersionId)
	...
	local function createSetGui()
		...
		setPanel.Parent = setGui
			...
			cancelButton.Parent = setPanel
				...
				cancelImage.Image = "http://www.anorrl.com/asset/?id=54135717"
	...
	local function createDropDownMenuButton(parent)
		...
		dropDownButton.Image = "http://www.anorrl.com/asset/?id=67581509"
...
t.CreateTerrainMaterialSelector = function(size,position)
	...
	for i,v in pairs(materialNames) do
		...
		if v == "Grass" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=56563112"
		elseif v == "Sand" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=62356652"
		elseif v == "Brick" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=65961537"
		elseif v == "Granite" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532153"
		elseif v == "Asphalt" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532038"
		elseif v == "Iron" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532093"
		elseif v == "Aluminum" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67531995"
		elseif v == "Gold" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532118"
		elseif v == "Plastic (red)" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67531848"
		elseif v == "Plastic (blue)" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67531924"
		elseif v == "Plank" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532015"
		elseif v == "Log" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532051"
		elseif v == "Gravel" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532206"
		elseif v == "Cinder Block" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532103"
		elseif v == "Stone Wall" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67531804"
		elseif v == "Concrete" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=67532059"
		elseif v == "Water" then materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=81407474"
		else materialToImageMap[v].Regular = "http://www.anorrl.com/asset/?id=66887593" -- fill in the rest here!!
		end
	end
...
t.CreateLoadingFrame = function(name,size,position)
	game:GetService("ContentProvider"):Preload("http://www.anorrl.com/asset/?id=35238053")
	...
	loadingBar.Parent = loadingFrame
		...
		loadingGreenBar.Image = "http://www.anorrl.com/asset/?id=35238053"
