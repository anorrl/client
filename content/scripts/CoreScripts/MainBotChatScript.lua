...
function styleMainFrame(tone)
	if tone == Enum.DialogTone.Neutral then
		...
		mainFrame.Tail.Image = "arlasset://textures/ui/chatBubble_botBlue_tailRight.png"
	elseif tone == Enum.DialogTone.Friendly then
		mainFrame.Style = Enum.FrameStyle.ChatGreen
		mainFrame.Tail.Image = "arlasset://textures/ui/chatBubble_botGreen_tailRight.png"
	elseif tone == Enum.DialogTone.Enemy then
		mainFrame.Style = Enum.FrameStyle.ChatRed
		mainFrame.Tail.Image = "arlasset://textures/ui/chatBubble_botRed_tailRight.png"
	end
...
function setChatNotificationTone(gui, purpose, tone)
	if tone == Enum.DialogTone.Neutral then
		gui.Image.Image = "arlasset://textures/ui/chatBubble_botBlue_notify_bkg.png"
	elseif tone == Enum.DialogTone.Friendly then
		gui.Image.Image = "arlasset://textures/ui/chatBubble_botGreen_notify_bkg.png"
	elseif tone == Enum.DialogTone.Enemy then
		gui.Image.Image = "arlasset://textures/ui/chatBubble_botRed_notify_bkg.png"
	end
	if purpose == Enum.DialogPurpose.Quest then
		gui.Image.Button.Image = "arlasset://textures/ui/chatBubble_bot_notify_bang.png"
	elseif purpose == Enum.DialogPurpose.Help then
		gui.Image.Button.Image = "arlasset://textures/ui/chatBubble_bot_notify_question.png"
	elseif purpose == Enum.DialogPurpose.Shop then
		gui.Image.Button.Image = "arlasset://textures/ui/chatBubble_bot_notify_money.png"
	end
end
...
function initialize(parent)
	...
	imageLabel.Position = UDim2.new(1,6,0.25, -5)
	imageLabel.Image = "arlasset://textures/ui/chatBubble_botBlue_tailRight.png"
