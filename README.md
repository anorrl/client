...
Alright, first. Grab the Visual Studio 2012 iso (and install VS2012) from [here](https://repo.lambda.cam/en_visual_studio_professional_2012_x86_dvd_2262334.iso), this is my repo so it should be fine!
