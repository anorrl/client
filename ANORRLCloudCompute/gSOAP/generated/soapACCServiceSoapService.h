...
#ifndef soapACCServiceSoapService_H
#define soapACCServiceSoapService_H
#include "soapH.h"
class SOAP_CMAC ACCServiceSoapService : public soap
{ public:
	/// Constructor
	ACCServiceSoapService();
	/// Constructor with copy of another engine state
	ACCServiceSoapService(const struct soap&);
	/// Constructor with engine input+output mode control
	ACCServiceSoapService(soap_mode iomode);
	/// Constructor with engine input and output mode control
	ACCServiceSoapService(soap_mode imode, soap_mode omode);
	/// Destructor frees all data
	virtual ~ACCServiceSoapService();
	/// Initializer used by constructor
	virtual	void ACCServiceSoapService_init(soap_mode imode, soap_mode omode);
	/// Create a copy
