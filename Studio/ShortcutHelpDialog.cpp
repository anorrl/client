...
ShortcutHelpDialog::ShortcutHelpDialog(ANORRLMainWindow& MainWindow)
...
void ShortcutHelpDialog::initialize()
{
    ...
    ARL::BaldPtr<QTreeWidgetItem> header_item = mTree->headerItem();
...
void ShortcutHelpDialog::populate()
{
    ...
    for ( ; iter != objects.end() ; ++iter )
    {
        ...
        {
            ARL::BaldPtr<QTreeWidgetItem> item = new QTreeWidgetItem(mTree);
