...
namespace Studio {
    ...
    {
        QResource metaDataResource(":/content/IntelleSenseMetadata.xml");
	...
	{
		if (ANORRLScriptDoc* scriptDoc = dynamic_cast<ANORRLScriptDoc *>(ANORRLDocManager::Instance().getCurrentDoc()))
		{
