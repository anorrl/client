...
void ANORRLTutorials::handleHomeClicked()
{
...
void ANORRLTutorials::disableLinks(const QUrl& url)
{
}

void ANORRLTutorials::urlChanged(const QUrl& url)
{
...
void ANORRLTutorials::linkClicked(const QUrl& url)
{
	if (m_firstClick) 
	{
		m_firstClick = false;
...
void ANORRLTutorials::setupWebView(QWidget *wrapperWidget)
{
	...
	m_pWebContentsView = new ANORRLBrowser(wrapperWidget);
