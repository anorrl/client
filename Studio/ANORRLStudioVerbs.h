...
class PublishToANORRLAsVerb: public ARL::Verb
{
public:
	PublishToANORRLAsVerb(ARL::VerbContainer* pVerbContainer, ANORRLMainWindow* mainWnd);
    virtual ~PublishToANORRLAsVerb();
...
class PublishToANORRLVerb : public ARL::Verb
{
public:
	PublishToANORRLVerb(ARL::VerbContainer* pVerbContainer, ANORRLMainWindow* mainWnd);
...
class PublishSelectionToANORRLVerb: public ARL::Verb
{
public:
	PublishSelectionToANORRLVerb(ARL::VerbContainer* pVerbContainer, ANORRLMainWindow* mainWnd);
    virtual ~PublishSelectionToANORRLVerb();
...
{
public:
	PublishAsPluginVerb(ARL::VerbContainer* pVerbContainer, ANORRLMainWindow* mainWnd);
...
{
public:
	ShutdownClientVerb(ARL::VerbContainer* container, IANORRLDoc *pDoc);
	virtual void doIt(ARL::IDataState* dataState);
	
private:
	IANORRLDoc *m_pIDEDoc;
};

class ShutdownClientAndSaveVerb : public ARL::Verb
{
public:
	ShutdownClientAndSaveVerb(ARL::VerbContainer* container, IANORRLDoc* pDoc);
	virtual void doIt(ARL::IDataState* dataState);
...
{
public:
	LeaveGameVerb(ARL::VerbContainer* container, IANORRLDoc *pDoc);
	virtual void doIt(ARL::IDataState* dataState);
...
public:
	...
	virtual bool isEnabled() const { return (ANORRLDocManager::Instance().getPlayDoc() != NULL); }
	virtual bool isChecked() const { return false; }
