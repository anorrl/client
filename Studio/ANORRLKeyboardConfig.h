...
class ShortcutsModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    ShortcutsModel(ANORRLMainWindow& mainWindow, QObject *parent);
...
//
class ANORRLKeyboardConfig
{
public:
    ANORRLKeyboardConfig();
    
    static ANORRLKeyboardConfig& singleton();

    void storeDefaults(ANORRLMainWindow& mainWindow);
    void loadKeyboardConfig(ANORRLMainWindow& mainWindow);
    void saveKeyboardConfig(ANORRLMainWindow& mainWindow);
...
//
class ANORRLKeyboardConfigWidget : public QWidget
{
    Q_OBJECT
public:
    ANORRLKeyboardConfigWidget(ANORRLMainWindow& mainWidnow, QWidget* parent);
    virtual ~ANORRLKeyboardConfigWidget() {}
...
private:
    ...
    ARL::BaldPtr<QTreeView>    m_treeView;
