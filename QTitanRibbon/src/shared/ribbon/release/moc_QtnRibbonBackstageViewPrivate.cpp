...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Qtitan__RibbonBackstageCloseButton_t, stringdata) + ofs \
...
void *Qtitan::RibbonBackstageCloseButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Qtitan__RibbonBackstageCloseButton.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Qtitan__RibbonBackstageViewPrivate_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_Qtitan__RibbonBackstageViewPrivate.stringdata))
