...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Qtitan__OfficeFrameHelperWin_t, stringdata) + ofs \
...
void *Qtitan::OfficeFrameHelperWin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Qtitan__OfficeFrameHelperWin.stringdata))
